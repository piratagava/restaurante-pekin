...
import com.restaurante.pekin.configurationJwt.JWTFilter;
import com.restaurante.pekin.configurationJwt.TokenProvider;
import com.restaurante.pekin.restAuthentication.dto.LoginDto;
...
public class AuthenticationRestController {
	...
	public ResponseEntity<JWTToken> authorize(@Valid @RequestBody LoginDto loginDto) {
		...
		System.out.print("Soy LoginDto"+ loginDto);
